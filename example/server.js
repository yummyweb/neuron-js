...
//     res.status(404).send("Error: Not Found " + err)
// }
...
neuronjs.GET('/:id', (req, res) => {
    res.json({ "deletedObj": {"name": "John Doe", "id": 902}, "success": true })
})

neuronjs.POST('/newuser', (req, res) => {
...
// 	app.view("hello.html", errFunc, successFunc, res)
// });
